...
<body>
	<form action="/HomeSystem/fc/companyCapacityRegister" method="post" enctype="multipart/form-data">
		<table id="forms">
			<tr><td>社内資格名：</td><td><input type="text" name="capacityName"></td></tr>
			<tr><td>社内資格説明：</td><td><textarea name="capacityComment"></textarea></td></tr>
		...
		<input type="submit" name="capacityRegister" value="登録">
	</form>
