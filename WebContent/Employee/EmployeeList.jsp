...
<div class="contents">
	<div class="searchPart">
		...
		<input type="submit" name="submit" value="検索" class="departmentButton">
		</div>
		<div class="genreList">
	...
	<div class="employeeListPart">
		...
		<c:forEach var="employee" items="${employees}" varStatus="status">
			<td class="employeeColumn">
				<div class="employeeImage"><a href="./EmployeePage?employeeId=${employee.employeeId}"><img src="../images/employees/${employee.employeeId}.jpg" ></a></div>
